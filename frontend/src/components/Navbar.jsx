      ...
      <nav className="flex">
        <div className="nav-parent-2 flex">
          <div className="nav-logo">
            <Link to="/">
              <div className="title-nav">GO GREEN</div>
            </Link>
          </div>
          <div className="nav-options flex">
            {isMobile ? (
              <Menu>
                ...
                <Link to="/biogas-community">
                      <MenuItem minH="40px">
                       <MdAir />
                        &nbsp;
                        <span>Bio gas community</span>
                      </MenuItem>
                    </Link>
                </MenuList>
              </Menu>
                ...
                <Menu>
                  ...
                  <Link to="/algae">
                      <MenuItem minH="40px">
                        <FiDroplet />
                        &nbsp;
                        <span>Algae Filter</span>
                      </MenuItem>
                    </Link>

                    <Link to="/biogas-distribution">
                      <MenuItem minH="40px">
                      <MdAir />
                        &nbsp;
                        <span>BioGas Distribution</span>
                      </MenuItem>
                    </Link>
